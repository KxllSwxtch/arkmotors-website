				...
				<div className='flex justify-center gap-6 mb-8'>
					{[
						...
						<button
							...
							className={`
								cursor-pointer flex items-center justify-center gap-2 p-3 text-lg font-bold rounded-xs shadow-xl transition-all duration-300
								${
									country === value
										? 'bg-gradient-to-r from-yellow-400 to-yellow-600 text-white scale-105 shadow-2xl'
										: 'bg-gradient-to-r from-gray-200 to-gray-300 text-gray-800 hover:from-yellow-400 hover:to-yellow-600 hover:text-white transition-all duration-300'
								}
								active:scale-95
							`}
							style={{
